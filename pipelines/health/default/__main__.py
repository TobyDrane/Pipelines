...
config = [
    {
        "lambda_name": "health_default_lambda1",
        "next": "health_default_lambda2"
    },
    {
        "lambda_name": "health_default_lambda2",
        "next": None
    }
]
...
def create_state_machine():
    core_create_state_machine("health-default", created_lambdas, config)
